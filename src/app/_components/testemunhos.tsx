    ...
    return (
        <section className="bg-[#FFD449] py-16">
            <div className=" container mx-auto px-4">
                ...
                <h2 className="text-4xl font-bold text-center mb-12" data-aos="fade-up">Depoimento dos nossos clientes</h2>

                <div className="relative max-w-4xl mx-auto">
                    <div className='overflow-hidden' ref={emblaRef}>
                        <div className='flex'>{testemunhos.map((item, index)=>(
                                <div key={index} className='flex-[0_0_100%] min-w-0 px-3'>
                                    <article className='bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col'>
                                        <div className='flex flex-col items-center text-center space-y-4'>
                                           ...
                                           <div>{/*essa div foi criada apenas para tirar o espaçamento do nome e do texto embaixo */}
